...
# -*- coding: utf-8 -*-
#
# evenz documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'evenz.tex', 'evenz Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'evenz', 'evenz Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'evenz', 'evenz Documentation',
     author, 'evenz', 'One line description of project.',
     'Miscellaneous'),
]
